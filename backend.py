...
@app.post("/analysis/")
async def get_result(input:User_input):
    with open(input.prompt_file, "rb") as f:
    ...
    context_result = {
            "paper_title": solar.paper_title,
            "DOI": solar.doi,
            "generation_model": solar.llm_id,
            "similarity_model": solar.embedding_id,
            "similarity_metric": "Cosine_Similarity",
            "rag_type": solar.rag_type,
            "result": []
    }
    ...
    for key, value in query_data.items():
        ...
        temp = solar.graphrag_pipeline(5, value, key)
